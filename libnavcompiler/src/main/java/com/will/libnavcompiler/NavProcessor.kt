package com.will.libnavcompiler

import com.alibaba.fastjson.JSON
import com.alibaba.fastjson.JSONObject
import com.google.auto.service.AutoService
import com.will.libnavannotation.ActivityDestination
...
@SupportedAnnotationTypes("com.will.libnavannotation.FragmentDestination","com.will.libnavannotation.ActivityDestination")
class NavProcessor : AbstractProcessor() {
    ...
    override fun process(
        ...
        if (fragmentDestination.isNotEmpty() || activityDestination.isNotEmpty()) {
            ...
            val destMap = hashMapOf<String?, Any?>()
